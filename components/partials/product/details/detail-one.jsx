...
function DetailOne ( props ) {
    ...
    function scrollHandler () {
        if ( router.pathname.includes( '/product/default' ) ) {
            console.log(ref.current?.querySelector( '.sticky-bar' ))
        ...
        <div className="product-details" ref={ ref }>
            ...
            <div className="ratings-container">
                <div className="ratings">
                    <div className="ratings-val" style={ { width: parseFloat(product.ratings) * 20 + '%' } }></div>
                    <span className="tooltip-text">{ parseFloat(product.ratings).toFixed( 2 ) }</span>
                </div>
                <span className="ratings-text">( { product.ratings } Reviews )</span>
            </div>
                        ...
                        <div className="col-6">
                            <figure className="product-media">
                                <ALink href={ `/product/default/${product.slug}` }>
                                    <img src={ process.env.NEXT_PUBLIC_AWS_S3_BASE_URL+"/" + product.images[ 0 ].url } alt="product" width={ product.images[ 0 ].width } height={ product.images[ 0 ].height } />
                                </ALink>
                            </figure>
